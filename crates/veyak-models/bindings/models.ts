...
export type ActiveState = { activeWorkspaceId: string | null, activeEnvironmentId: string | null, activeThemeId: string | null, activeCollectionId: string | null, activeFolderId: string | null, activeItemId: string | null, };
...
export type ThemeSyntax = { comment: string, property: string, string: string, number: string, null: string, function: string, variable: string, attribute: string, className: string, boolean: string, keyword: string, punctuation: string, operator: string, };
